...
public class BanHistInventorry implements InventoryProvider{
	...
	public void init(Inventory inv) {
		List<Ban> bans = Terminator.get().getBanManager().getSortedBanHistory();
	...
	private ItemStack getBanSkull(UUID uuid , Ban ban) {
		...
		String status = ban.isDeleted() ? "§a§l[Expiré]" : "§c§l[Active]";lore.add(status);
		meta.setLore(lore);
