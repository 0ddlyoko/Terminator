...
public class MuteManager {
	 ...
	 *                          If error
	 */
	public long getMutesanGivenCount(UUID uuid, DatabaseModel model) throws SQLException {
		Connection c = null;
		PreparedStatement s = null;
		ResultSet rs = null;
		try {
			...
			Bukkit.getLogger().log(Level.SEVERE,
					"getMutesanGivenCount: SQLException while retrieving number of mutes for player " + uuid, ex);
			throw ex;
		} finally {
			close(c, s, rs);
		}
