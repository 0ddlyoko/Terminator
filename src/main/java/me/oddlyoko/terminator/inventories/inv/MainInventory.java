...
public class MainInventory implements InventoryProvider {
	...
	public static final org.bukkit.inventory.ItemStack MuteHead = ItemBuilder.of(Material.PLAYER_HEAD).name("§c§lMUTES")
			.lore(Arrays.asList("§bVoir l'historique des mutes"))
			.texture(
			...
			.build();
	public static final org.bukkit.inventory.ItemStack BanHead = ItemBuilder.of(Material.PLAYER_HEAD).name("§c§lBANS")
			.lore(Arrays.asList("§bVoir l'historique des bans"))
			.texture(
			...
			.build();
	public static final org.bukkit.inventory.ItemStack KickHead = ItemBuilder.of(Material.PLAYER_HEAD).name("§c§lKICKS")
			.lore(Arrays.asList("§bVoir l'historique des bans"))
			.texture(
